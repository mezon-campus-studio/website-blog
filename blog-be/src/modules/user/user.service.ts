...
import { deleteAvatarFromCloudinary, uploadAvatarToCloudinary, CloudinaryAvatar } from "@/common/utils/cloudinary";
   ...
   async updateAvatar(userId: string, file?: Express.Multer.File) {
      ...
      try {
         ...
         if (uploadedAvatar) {
            ...
            await deleteAvatarFromCloudinary(publicId).catch((rollbackError) => {
